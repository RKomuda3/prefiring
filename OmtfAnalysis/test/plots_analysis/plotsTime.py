...
def chTimePrefireEta(canvas):
    ...
    hhTimePrefireEta.SetTitle("Prefiring \, fraction \, for \, p_{T} \geq 10 \, GeV; L1\eta [-]; bx-1/(bx-0 or bx-1)")
...
def chTimePrefireEta1(canvas):
    ...
    hhTimePrefireEta1.SetTitle("Prefiring \, with \, OMTF \, veto (PHI) \, for  \, p_{T} \geq \, 10 GeV; L1\eta [-]; bx-1/(bx-0 or bx-1)")
...
def chTimePrefireEtahitpattern(canvas):
    c=TCanvas("chTimePrefireEtahitpattern","chTimePrefireEtahitpattern",1400,800)
    canvas.Add(c)
    c.SetGridy(100)
    c.SetGridx(100)
    hhTimePrefireEta1 = gROOT.FindObject("hTimePrefireEtahitpattern")
    hhTimePrefireEta1.SetLineColor(1)
    hhTimePrefireEta1.SetTitle("Prefiring \, with \, OMTF \, veto (HIT) \, for  \, p_{T} \geq \, 10 GeV; L1\eta [-]; bx-1/(bx-0 or bx-1)")
    hhTimePrefireEta1.Draw()
    c.Update()
    graph = hhTimePrefireEta1.GetPaintedGraph()
    graph.GetYaxis().SetNdivisions(808)
...
def chTimePrefireEtaFInal(canvas):
    ...
    hhTimePrefireEta1.SetMarkerColor(2)
    hhTimePrefireEtahitpattern.SetMarkerStyle(29)
    hhTimePrefireEtahitpattern.SetMarkerColor(3)
    hhTimePrefireEtahitpattern.SetMarkerSize(2.5)
    hhTimePrefireEtafinal.SetMarkerStyle(21)
    hhTimePrefireEtafinal.SetMarkerColor(4)
    hhTimePrefireEta.SetTitle("Prefiring \, fraction  \, for  \, L1p_{T} \geq \, 10 GeV; L1\eta [-]; bx-1/(bx-0 or bx-1)")
    hhTimePrefireEta.Draw()
    ...
    canvas.Add(legend)
    legend.AddEntry(hhTimePrefireEta,"Initial","lp")
    legend.AddEntry(hhTimePrefireEta1,"\Delta \phi veto","lp")
    legend.AddEntry(hhTimePrefireEtahitpattern,"Hit pattern veto","lp")
    legend.AddEntry(hhTimePrefireEtafinal,"Both","lp")
    legend.Draw()
    c.Update()
    return
...
def cDeltaphieta025(canvas):
  ...
  hDeltaphieta010_025.SetTitle("OMTF \ between \, bx0 \, and \, bx-1 \ p_T<10 GeV; \Delta \eta; \Delta \phi ")
...
def  chTimePtbinning(canvas):
    ...
    hTimePtbinning.GetXaxis().SetBinLabel(2,"bx-1 and bx0")
    hTimePtbinning.GetXaxis().SetBinLabel(1,"bx-1")
...
def  chTimePtbinninghitpattern(canvas):
    
    pad = TPad("pad", "Pad", 0, 0, 1, 1)
    pad.SetLeftMargin(0.2) 
    c=TCanvas("chTimePtbinninghitpattern","chTimePtbinninghitpattern",1600,1000)
    
    pad.Draw()
    pad.cd()
    
    canvas.Add(c)
    hTimePtbinning=gROOT.FindObject("hTimePtbinninghitpattern")
    hTimePtbinning.GetYaxis().SetBinLabel(1,"p_{t}<10 GeV")
    hTimePtbinning.GetYaxis().SetBinLabel(2,"10 GeV $\\leq$ p_{t} $<$22 GeV")
    hTimePtbinning.GetYaxis().SetBinLabel(3,"p_{t}$\\geq$22 GeV")
    hTimePtbinning.GetXaxis().SetBinLabel(2,"bx-1 and bx0")
...
def chTimePrefireEta1divide(canvas):
  c = TCanvas("chTimePrefireEta1divide","chTimePrefireEta1divide",1400,400)
  canvas.Add(c)
  c.Divide(3)
  pad1 = c.cd(1)
  hTimePrefireEta1BMTF = gROOT.FindObject("hTimePrefireEta1BMTF")
  hTimePrefireEta1BMTF.SetLineColor(1)
  hTimePrefireEta1BMTF.SetTitle("Prefiring \, (after \, Veto) \,  for  \, p_{T} \geq \, 10 GeV \, in \, BMTF; L1\eta [-]; bx-1/(bx-0 or bx-1)")

  hTimePrefireEta1BMTF.Draw()
  c.Update()
  graph = hTimePrefireEta1BMTF.GetPaintedGraph()
  graph.GetYaxis().SetNdivisions(808)
  graph.GetXaxis().SetNdivisions(808)
  graph.SetStats(1)
  ...
  yaxis.SetRangeUser(0.0,0.0035) 
  c.Update()
  
  
  pad2 = c.cd(2)
  hTimePrefireEta1OMTF = gROOT.FindObject("hTimePrefireEta1OMTF")
  hTimePrefireEta1OMTF.SetLineColor(1)
  hTimePrefireEta1OMTF.SetTitle("Prefiring \, (after \, Veto) \,  for  \, p_{T} \geq \, 10 GeV \, in \, OMTF; L1\eta [-]; bx-1/(bx-0 or bx-1)")
  hTimePrefireEta1OMTF.Draw()
  c.Update()
  graph = hTimePrefireEta1OMTF.GetPaintedGraph()
  graph.GetYaxis().SetNdivisions(808)
  graph.GetXaxis().SetNdivisions(808)
  yaxis = graph.GetYaxis()
  yaxis.SetTitleOffset(1.7)  
  ...
  pad3 = c.cd(3)
  hTimePrefireEta1EMTF = gROOT.FindObject("hTimePrefireEta1EMTF")
  hTimePrefireEta1EMTF.SetLineColor(1)
  hTimePrefireEta1EMTF.SetTitle("Prefiring \, (after \, Veto) \,  for  \, p_{T} \geq \, 10 GeV \, in \, EMTF; L1\eta [-]; bx-1/(bx-0 or bx-1)")
  hTimePrefireEta1EMTF.Draw()
  c.Update()
  graph = hTimePrefireEta1EMTF.GetPaintedGraph()
  graph.GetYaxis().SetNdivisions(808)
  graph.GetXaxis().SetNdivisions(808)
  graph.SetStats(1)
  yaxis = graph.GetYaxis()
...
def chTimePrefireEtadivide(canvas):
  c = TCanvas("chTimePrefireEtadivide","chTimePrefireEtadivide",1400,400)
  canvas.Add(c)
  c.Divide(3)
  pad1 = c.cd(1)
  hTimePrefireEtaBMTF = gROOT.FindObject("hTimePrefireEtaBMTF")
  hTimePrefireEtaBMTF.SetLineColor(1)
  hTimePrefireEtaBMTF.SetTitle("Prefiring \,  for  \, p_{T} \geq \, 10 GeV \, in \, BMTF; L1\eta [-]; bx-1/(bx-0 or bx-1)")

  hTimePrefireEtaBMTF.Draw()
  c.Update()
  graph = hTimePrefireEtaBMTF.GetPaintedGraph()
  graph.GetYaxis().SetNdivisions(808)
  graph.GetXaxis().SetNdivisions(808)
  graph.SetStats(1)
  yaxis = graph.GetYaxis()
  ...
  pad2 = c.cd(2)
  hTimePrefireEtaOMTF = gROOT.FindObject("hTimePrefireEtaOMTF")
  hTimePrefireEtaOMTF.SetLineColor(1)
  hTimePrefireEtaOMTF.SetTitle("Prefiring \,  for  \, p_{T} \geq \, 10 GeV \, in \, OMTF; L1\eta [-]; bx-1/(bx-0 or bx-1)")
  hTimePrefireEtaOMTF.Draw()
  c.Update()
  graph = hTimePrefireEtaOMTF.GetPaintedGraph()
  graph.GetYaxis().SetNdivisions(808)
  graph.GetXaxis().SetNdivisions(808)
  yaxis = graph.GetYaxis()
  yaxis.SetTitleOffset(1.7)  
  ...
  pad3 = c.cd(3)
  hTimePrefireEtaEMTF = gROOT.FindObject("hTimePrefireEtaEMTF")
  hTimePrefireEtaEMTF.SetLineColor(1)
  hTimePrefireEtaEMTF.SetTitle("Prefiring \,  for  \, p_{T} \geq \, 10 GeV \, in \, EMTF; L1\eta [-]; bx-1/(bx-0 or bx-1)")
  hTimePrefireEtaEMTF.Draw()
  c.Update()
  graph = hTimePrefireEtaEMTF.GetPaintedGraph()
  graph.GetYaxis().SetNdivisions(808)
  graph.GetXaxis().SetNdivisions(808)
  graph.SetStats(1)
  yaxis = graph.GetYaxis()
...
#  cTimeEta(canvas)
   ...
   chTimePrefireEtahitpattern(canvas)
...
#  chTimePt22(canvas)
   ...
   chTimePtbinninghitpattern(canvas)
   cTimeEffPt1(canvas)
