...
def chTimePrefireEta(canvas):
    ...
    hhTimePrefireEta.SetTitle("Prefiring \, for \, p_{T} \geq 10 \, GeV; \eta [-]; bx-1/(bx-0 or bx-1)")
...
def chTimePrefireEta1(canvas):
    ...
    hhTimePrefireEta1.SetTitle("Prefiring \, with \, OMTF \, veto \, for  \, p_{T} \geq \, 10 GeV; \eta [-]; bx-1/(bx-0 or bx-1)")
